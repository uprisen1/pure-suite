        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 shrink-0">
            ...
            <div>
              ...
              <span className="hidden sm:inline-block ml-3 px-2 py-0.5 border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 rounded-full text-[10px] font-semibold text-slate-500 dark:text-slate-400 font-mono">
                SECURE SANDBOX
              </span>
            </div>
          </div>
              ...
              <div className="space-y-6">
                <div className="text-center max-w-2xl mx-auto space-y-2 mt-2">
                  <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-tight">
                    Secure & Minimalist PDF Engine
                  </h1>
                  <p className="text-sm text-slate-500 dark:text-slate-400">
                    100% cloud-free sandbox processing. Convert, markup, split and merge files smoothly inside dynamic browser micro-thread stack memory.
                  </p>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-800 max-w-3xl mx-auto flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left shadow-sm">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 leading-normal">
                      Your files remain entirely encrypted and processed inside your dynamic browser micro-thread stack memory. Neither payload parameters nor byte metadata are mapped through telemetry logs or remote databases.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <footer className="mt-auto border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 py-5 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-2">
          <p className="text-xs text-slate-400 dark:text-slate-500">
            © 2026 PureSuite Platform. All file calculations and modifications remain inside browser microprocess storage threads. Security metrics complied statically.
          </p>
          <div className="flex items-center justify-center gap-4 text-[10px] text-slate-400 dark:text-slate-500 font-mono flex-wrap">
            <span>🔏 256-bit sandbox buffers</span>
            <span>•</span>
            <span>⚖️ Compliant privacy criteria</span>
            <span>•</span>
            <span>⚡ Zero Telemetry logs saved</span>
          </div>
        </div>
      </footer>
